...
$idp_host = env('SAML2_'.$this_idp_env_id.'_IDP_HOST', 'https://adfsftv.francetv.fr/adfs/ls/');
...
return $settings = array(
    ...
    'organization' => array(
        'fr-FR' => array(
            'name' => 'FranceTV Lab',
            'displayname' => 'FranceTV Lab',
            'url' => 'https://www.francetvlab.fr/'
        ),
    ),
